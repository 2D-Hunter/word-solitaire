    ...
    public class GetItem : MonoBehaviour
    {
        ...
        void Explostion()
        {
            ...
            sequence.AppendCallback( ()=>
            {
                ...
                FindAnyObjectByType<Example>().coinCntr++;
                Debug.Log("gameObject.SetActive: "+ FindAnyObjectByType<Example>().coinCntr);
                FBPlayerData.instance.VibrationEffect();
                SoundManager.instance.PlaySFX("CoinCollect", 0.5f);
                if (FindAnyObjectByType<Example>().coinCntr >= 20)
                {
                    if(InitManager.instance.CurrentScene == "Game")
                        GameManager.instance.SetOriginalPosOfCoinHud();
                    InitManager.instance.StartCoroutine(InitManager.instance.RemoveCoinAnim(0.1f));
