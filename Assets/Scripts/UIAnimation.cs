...
public class UIAnimation : MonoBehaviour
{
	...
	public static UIAnimation Alpha(GameObject gameObject, float to, float duration)
	{
		return CreateAnimation(Type.Alpha, gameObject, true, 0, to, duration);
	}

	public static UIAnimation Alpha(GameObject gameObject, float from, float to, float duration)
	{
